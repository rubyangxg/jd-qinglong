(function () {
    ...
    _proto.initImg = function () {
        ...
        img.onload = function () {
            ...
            console.log("draw imgBolock")
            drawImg(that.blockCtx, 'fill');
            that.blockCtx.drawImage(imgBolock, 0, 0, L, 170);
            var ImageData = that.blockCtx.getImageData(0, 0, L, 170);
            that.block.width = L;
        ...
        imgBolock.setSrc = function () {
            var src = '';
            loadCount = 0;
            that.text.classList.remove('text-danger');
            if (isFunction(that.options.smallSrc)) src = that.options.smallSrc();
    ...
    _proto.bindEvents = function () {
        ...
        var handleDragMove = function (e) {
            ...
            var point = '(' + moveX + ',' + moveY + ',' + new Date().getTime() + ')';
            trail.push(point);
        };
